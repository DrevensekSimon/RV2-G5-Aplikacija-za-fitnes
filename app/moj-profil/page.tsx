        ...
        <div className="mt-6 grid gap-6 md:grid-cols-[2fr,1fr]">
          ...
          <div className="space-y-6">
            ...
            <section className="rounded-2xl border bg-white p-6 shadow-sm">
              ...
              <div className="mt-5 border-t pt-4">
                <Link href="/moj-profil/narocnina" className="w-full block text-center rounded-xl bg-gray-900 px-4 py-2 text-xs font-semibold text-white hover:bg-black">Upravljanje naročnine</Link>
              </div>
            </section>
          ...
          <aside className="space-y-6">
            ...
            <section className="rounded-2xl border bg-white p-6 text-center shadow-sm">
              ...
              {/* Name and ID */}
              <div className="mt-4">
                <div className="text-lg font-extrabold">{user.first_name} {user.last_name}</div>
                <div className="text-xs text-gray-500 mt-1">ID</div>
              </div>
              
              {/* Edit Profile Button */}
              <button className="w-full mt-4 inline-flex items-center justify-center gap-2 rounded-xl border px-3 py-2.5 text-sm font-medium hover:bg-gray-50">
                ⚙️ Uredi Profil
              </button>
              ...
              <div className="mt-6 space-y-3 text-sm">
                ...
                <div>
                  <div className="text-gray-400 text-xs">Spremeni geslo</div>
                </div>
                <div>
                  <div className="text-gray-400 text-xs">Uredi plačila</div>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-2xl border bg-white p-6 shadow-sm">
              <div className="flex items-center justify-between">
                ...
                <button className="relative inline-flex h-6 w-11 items-center rounded-full bg-gray-800 hover:bg-gray-700 transition">
